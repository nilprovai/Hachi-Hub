...
local Themes = {
    ...
    ["Hachi Hub"] = {
        ...
        Miscellaneous = {
            Divider = Color3.fromRGB(30, 180, 255), 
            Shadow = Color3.fromRGB(24, 23, 26), 
            LighterShadow = Color3.fromRGB(40,40,48), 
        },
        Accents = {
            Main = ColorSequence.new {
                ColorSequenceKeypoint.new(0.0, Color3.fromRGB(30, 180, 255)), 
                ColorSequenceKeypoint.new(0.5, Color3.fromRGB(100, 210, 255)),
                ColorSequenceKeypoint.new(1.0, Color3.fromRGB(30, 180, 255))
            },
            Brighter = ColorSequence.new {
                ColorSequenceKeypoint.new(0.0, Color3.fromRGB(100, 210, 255)), 
                ColorSequenceKeypoint.new(0.5, Color3.fromRGB(150, 230, 255)),
                ColorSequenceKeypoint.new(1.0, Color3.fromRGB(100, 210, 255))
            }
        }
    },
	Orca = {
